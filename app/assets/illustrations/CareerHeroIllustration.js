...
// hooks
import useHoverParallax from 'app/hooks/useHoverParallax';
// components
    ...
    >
          ...
          <m.div style={{ y: offsetY(-50) }}>
            <Label
              ...
              icon={
                <Image
                  alt="accounting"
                  app="/assets/icons/ic_accounting.svg"
        ...
        <m.div style={{ x: offsetX(80), y: offsetY(80) }}>
          <Label
            ...
            icon={
              <Image
                alt="banking"
                app="/assets/icons/ic_banking_currency.svg"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
        ...
        <m.div style={{ y: offsetY(80) }}>
          <Label
            ...
            icon={
              <Image
                alt="health care"
                app="/assets/icons/ic_health_care.svg"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
          ...
          <Label
            ...
            icon={
              <Image
                ...
                app="/assets/icons/ic_software_development.svg"
                sx={{ width: 48, height: 48 }}
              />
            }
          />
      ...
      <Box sx={{ position: 'absolute', top: 16, transform: 'translateX(20px)' }}>
        <m.div style={{ x: offsetX(50), y: offsetY(50) }}>
          <Icon
            color={YELLOW}
            content={<SvgColor app="/assets/icons/ic_creativity.svg" sx={{ ...stylesIcon }} />}
          />
        </m.div>
      </Box>
      ...
      <Box sx={{ position: 'absolute', bottom: 16, transform: 'translateX(40px)' }}>
        <m.div style={{ x: offsetX(-60), y: offsetY(60) }}>
          <Icon
            color={GREEN}
            content={
              <SvgColor app="/assets/icons/ic_marketing_bullhorn.svg" sx={{ ...stylesIcon }} />
            }
          />
        </m.div>
      </Box>
      ...
      <Box sx={{ position: 'absolute', bottom: 220, transform: 'translateX(-220px)' }}>
        <m.div style={{ x: offsetX(70), y: offsetY(70) }}>
          <Icon
            color={BLUE}
            content={
              <SvgColor app="/assets/icons/ic_customer_service.svg" sx={{ ...stylesIcon }} />
            }
          />
        </m.div>
      </Box>
