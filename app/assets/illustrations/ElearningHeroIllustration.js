    ...
    >
      <Box sx={{ position: 'absolute', right: 18, bottom: 28, zIndex: 8 }}>
        <Image
          ...
          disabledEffect
          alt="teacher"
          app="/assets/images/course/course_teacher_hero.png"
      ...
      >
        <Image
          ...
          disabledEffect
          alt="pencil icon"
          app="/assets/icons/ic_pencil.png"
        ...
        <Label
          ...
          icon={
            <Image
              ...
              disabledEffect
              alt="python"
              app="/assets/icons/platforms/ic_platform_python.svg"
